...
חכמי העדה מקרבים אותם, מסבירים להם את עיקרי היהדות ומאפשרים להם גיור מתוך קבלת האמונה ותפיסה עמוקה של חשיבות תפקידו של עם ישראל - ומסייעים להם לחזור לחיק עמם.`,
