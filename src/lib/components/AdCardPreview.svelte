<script lang="ts">
    ...
    // מסך הניהול לתצוגה מקדימה: ריחוף על כותרת (דסקטופ) או הקשה
    // עליה (נייד). אותן שכבות ואותם משתני עיצוב מהבילדר —
...
<style>
    ...
    /* עוגן "מעל ה-CTA": מרכז הלוגו על --diag-top-right (18px = חצי גובה) */
    .promo-logo-cta {
        top: auto;
