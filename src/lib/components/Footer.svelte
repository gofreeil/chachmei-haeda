...
<footer class="site-footer bg-[#0d1117] border-t border-white/10 py-1 md:py-2 mt-3 md:mt-0">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <nav aria-labelledby="network-links-title" class="hidden md:block border-b border-white/10 py-3">
            <h2 id="network-links-title" class="mb-1.5 text-xs font-black tracking-wide text-amber-400/90">
                רשת יוצאים לחירות
            </h2>
            <ul class="flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px] md:text-xs font-semibold text-gray-400">
        ...
        <div
            class="flex flex-col md:flex-row items-center justify-between gap-1 md:gap-6"
        >
