<script lang="ts">
	 ...
	 * בשני המצבים מוצגת רשת הלוגואים של כל האתרים.
	 *
	 * עצמאי בכוונה: קורא את ה-URL דרך window.location ב-onMount (לא $app/state) ומציג
	 * את רשת הלוגואים מהרשימה הקנונית networkSites (כל 10 האתרים, כולל האתר הנוכחי) —
	 * ללא תלות במבנה ה-adsData או ב-i18n.
	 */
	...
	const LOGO_SRC = '/images/chachmei-logo.webp';
