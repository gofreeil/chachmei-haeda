...
<section class="mb-10">
	<header class="text-center mb-6">
		...
		<p class="mt-2 text-gray-700 text-sm md:text-base font-bold">משפט וצדק <span class="text-amber-600">◆</span> שלום ואחווה <span class="text-amber-600">◆</span> הרוח <span class="text-amber-600">◆</span> המעשה</p>
	</header>
