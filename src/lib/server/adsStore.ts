...
//
// פורט מפינת האבדות (avedot) — אותו דגם אחסון משותף:
...
// _site='chachmim' — שיוך קשיח לאתר הזה; בלעדיו הפרסומת לא קיימת כאן.
...
// והבדיקה קשיחה: רק 'chachmim' שייך לכאן. פרסומת בלי _site היא פרסומת
// ותיקה של "קהילה בשכונה" — לא מוצגת כאן.
const SITE_ID = 'chachmim';
