// ============================================================
// Strapi 5 HTTP Client — חכמי העדה (צד-שרת, לסטודיו הפרסומות)
// משותף עם שאר אתרי הרשת — אותו STRAPI_URL + STRAPI_TOKEN.
// כל בקשה של הסטודיו לבאקאנד עוברת דרך כאן (קליינט הדפדפן של האתר יושב ב-src/lib/strapi.ts). כש-STRAPI_TOKEN חסר הקריאות נכשלות והצרכנים מחזירים רשימות ריקות עם console.warn.
// ============================================================

import { env } from '$env/dynamic/private';

export const STRAPI_URL = env.STRAPI_URL || 'https://api.gofreeil.com';
...
export interface StrapiMe {
    ...
    phone?: string | null;
    city?: string | null;
    /** תפקיד ניהולי ברשת (super_admin / ch_admin / ...) — לשערת האדמין */
