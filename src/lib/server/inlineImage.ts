...
// קאש ארוך.
//
// שים לב: באתר הזה אין hooks.server ואף נתיב לא מוסיף Set-Cookie, ולכן
// אין צורך במעקף auth — אבל אם יתווסף אי-פעם hooks שמצמיד עוגייה, נתיב
// התמונות חייב לעקוף אותו: Vercel לעולם לא שומר בקאש תשובה עם עוגייה.
// ============================================================
