...
<section class="py-8">
	...
	<div class="space-y-5 max-w-3xl mx-auto">
		{#each filtered as q (q.slug)}
			<article id={q.slug} class="rounded-2xl border border-indigo-400/30 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 p-5 md:p-6 target:ring-2 target:ring-indigo-500">
