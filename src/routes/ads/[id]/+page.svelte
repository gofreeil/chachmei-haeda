<script lang="ts">
    // דף נחיתה של פרסומת מאושרת — פורט מפינת האבדות (במקור מ"קהילה בשכונה"),
    // מולבש על ערכת הקלף הבהירה של חכמי העדה (ההירו נשאר בגרדיאנט המפרסם).
...
<svelte:head>
    <title>{ad.title} | חכמי העדה</title>
    {#if lp.pitch}
